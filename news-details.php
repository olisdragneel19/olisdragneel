...
<html lang="en">
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/png">
    ...
    <title>Front Page | News Detail</title>
...
<input type="text" name="name" class="form-control" placeholder="Masukan nama lengkap" required>
 ...
 <input type="email" name="email" class="form-control" placeholder="Masukan email" required>
                ...
                <div class="form-group">
                  <textarea class="form-control" name="comment" rows="3" placeholder="Komen" required></textarea>
                </div>
...
<?php include('includes/sidebar.php');?>
                ...
                <h2><a href="category.php?catid=2" class="News-heading">Baca lebih banyak</a></h2>
                 <div class="imgprops" style="height:auto;">
                  <!-- Blog Post -->
   <?php 
