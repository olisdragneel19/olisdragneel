...
<body>
  <section class="header-box fixed-bar ">
    ...
    <h2 class="brand"><a href="index.php"><span style="color: red">O</span>lisDragneel </a></h2>
    


  <ul class="top-nav">
    <a href="index.php" ><li class="nav" id="c-color"> Home <i class="fa fa-circle" style="font-size: 8pt;  "></i></li></a>
   <a href="category.php?catid=18"><li class="nav">CreepyPasta</li></a>
   <a href="category.php?catid=19"><li class="nav">Urban Legend</li></a>
   <a href="category.php?catid=20"><li class="nav">Mitologi</li></a>
   <a href="category.php?catid=21"><li class="nav">Tutor Bundir</li></a>
   <a href="contact-us.php"><li class="nav"> Kontak</li></a>
   <a href="about-us.php"><li class="nav"> Tentang</li></a>
...
<!--top navigation -->
         ...
         <div id="mySidenav" class="sidenav">
            ...
            <div>
              <a href="javascript:void(0)" class="sub-side-container"> Bantuan dan dukungan</a>
              <hr>
              <a href="contact-us.php"> Kontak</a>
              <a href="about-us.php"> Tentang</a>
              <!--<a href="Write-for-us.php" class="w-f-u"> <i class="fa fa-book"></i> Pengajuan cerita</a>-->
            </div>
            </div>
          </div>
        ...
        <script>
            ...
            <br><br><br>  <div class="row">
                <div class="side">
                  <!--<h5 class="categorytitlediff" > <a href="category.php?catid=18" class="News-heading">Tes1</a></h5>-->
...
<img class="postimgtopt" src="admin/postimages/<?php echo htmlentities($row['PostImage']);?>" alt="<?php echo htmlentities($row['posttitle']);?>">
          <div class="card-body" >
            ...
            <a href="news-details.php?nid=<?php echo htmlentities($row['pid'])?>" class="btn btn-primary">Selengkapnya &rarr;</a>
          </div>
